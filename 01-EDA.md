...
1. ศิลปินที่มีภาพรวมของเพลงที่ติดท็อปเป็นเพลงช้า ให้พลังงานน้อย หรือเหมาะกับการเต้นน้อยที่สุดเป็น 5 อันดับแรก ได้แก่ใครบ้าง?
...
จากการสังเกต ทำให้ทราบว่า Dataset ชุดนี้มีข้อมูลทั้งหมด 603 แถว และมีตัวแปร 15 ตัว ดังนี้
...
5. `year` คือ ปีที่เพลงติดท็อปบน Spoity ซึ่งอยู่ในช่วง 2010 จนถึง 2019
6. `bpm` คือ ความเร็วของเพลง มีหน่วยเป็นจังหวะต่อนาที (BPM หรือ Beats Per Minute) ถูกระบุอยู่ในช่วงตั้งแต่ 0 จนถึง 220 มีประเภทเป็น `double`
7. `nrgy` คือ พลังงานของเพลง ถูกระบุอยู่ในช่วงตั้งแต่ 0 (น้อย) จนถึง 100 (มาก) (มีค่ามากแสดงว่ามีพลังงานมาก) มีประเภทเป็น `double`
8. `dnce` คือ ความเหมาะสมของเพลงกับการเต้น (โดยอิงจากการผสมผสานขององค์ประกอบทางดนตรี) ถูกระบุอยู่ในช่วงตั้งแต่ 0 (น้อย) จนถึง 100 (มาก) (มีค่ามากแสดงว่าเหมาะกับการเต้นมาก) มีประเภทเป็น `double`
9. `dB` คือ ความดังของเพลง มีหน่วยเป็นเดซิเบล (dB หรือ decibel) ถูกระบุอยู่ในช่วงตั้งแต่ -60 (เบา) จนถึง 0 (ดัง) (มีค่ามากแสดงว่ามีความดังมาก) มีประเภทเป็น `double`
10. `live` คือ ความสดใหม่ของเสียงเพลง ถูกระบุอยู่ในช่วงตั้งแต่ 0 (น้อย) จนถึง 75 (มาก) (มีค่ามากแสดงว่ามีโอกาสเป็นการบันทึกสด (live recording) มาก) มีประเภทเป็น `double`
11. `val` คือ อารมณ์ของเพลง ถูกระบุอยู่ในช่วงตั้งแต่ 0 (ด้านลบ) จนถึง 100 (ด้านบวก) (มีค่ามากแสดงว่าให้อารมณ์ด้านบวกมาก) มีประเภทเป็น `double`
12. `dur` คือ ความยาวเพลง เป็นระยะเวลาของเสียงเพลงดังต่อเนื่องกัน ถูกระบุอยู่ในช่วงตั้งแต่ 120 จนถึง 440 มีหน่วยเป็นวินาที (second) มีประเภทเป็น `double`
13. `acous` คือ ความเป็นอะคูสติก ถูกระบุอยู่ในช่วงตั้งแต่ 0 (น้อย) จนถึง 100 (มาก) (มีค่ามากแสดงว่ามีโอกาสเป็นอะคูสติก (acoustic) มาก) มีประเภทเป็น `double`
14. `spch` คือ ปริมาณเสียงคำพูดที่มีปรากฏ ถูกระบุอยู่ในช่วงตั้งแต่ 0 (น้อย) จนถึง 50 (มาก) (มีค่ามากแสดงว่ามีโอกาสเป็นการบันทึกเสียงพูดโดยเฉพาะมาก เช่น ทอล์กโชว์ หนังสือเสียง เป็นต้น) มีประเภทเป็น `double`
15. `pop` คือ ความนิยมของเพลง ถูกระบุอยู่ในช่วงตั้งแต่ 0 (น้อย) จนถึง 100 (มาก) (มีค่ามากแสดงว่าเป็นที่นิยมมาก) มีประเภทเป็น `double`

โดยเบื้องต้นพบว่า
- ควรเปลี่ยนชื่อคอลัมน์เพื่อความเข้าใจง่ายในการอ่านและตีความข้อมูล
- ควรแปลงคอลัมน์ top genre (ประเภทของเพลง) เป็น factor
...
- dB หรือ ความดังของเพลง มีค่าเท่ากับ -60 dB สามารถเป็นไปได้ยาก เพราะถือว่าเบามาก
...
ศิลปินที่มีภาพรวมของเพลงที่ติดท็อปเป็นเพลงช้า ให้พลังงานน้อย หรือเหมาะกับการเต้นน้อยที่สุด คือ Passenger ตามด้วย John Legend, A Great Big World, Sleeping At Last และ Christina Perri
